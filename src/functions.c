...
{0, 0, " "}, {0, 0, " "},
    ...
    {1, 5, "round"}, {1, 5, "floor"}, {1, 4, "ceil"}, {1, 4, "getr"}, {1, 4, "geti"}, {1, 4, "getu"},
    {2, 5, "equal"}, {2, 9, "not_equal"}, {2, 2, "lt"},{2, 2, "gt"},{2, 8, "lt_equal"},{2, 8, "gt_equal"},
    {2, 3, "min"}, {2, 3, "max"}, {3, 4, "lerp"}, {2, 4, "dist"},
    {0, 0, " "}, {0, 0, " "},
